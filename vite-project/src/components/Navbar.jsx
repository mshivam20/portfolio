...
function Navbar(){
    ...
    return(
        ...
        <div className="bg-[rgb(1,2,22)]  w-full h-14 text-amber-50  font-bold fixed flex justify-between items-center px-4 border-b border-blue-300 ">
            ...
            <div className={`${isMenuOpen ? "translate-x-0" : "translate-x-96"} nav justify-self-end fixed top-0 right-0 w-50 h-screen z-50 bg-[#1B263B] transition-transform duration-300`}>
